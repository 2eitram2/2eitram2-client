import  {clearChat, base64ToBuffer} from './utils.js'
import {openChatContainer} from './uiChatInteract.js'
import { stringToUint8Array } from './convertions.js';
import {sendKyberKey} from './tcp.js';
import {encryptData, decryptMessage, getDecryptionKey, encryptMessage} from './encryption.js'
        ...
        cursorRequest.onsuccess = async (event) => {
            ...
            const processMessage = (async () => {
                try {
                    ...
                    const decryptedMessage = new TextDecoder().decode(firstDecrypt);
